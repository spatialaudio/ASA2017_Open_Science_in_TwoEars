...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Open Science in the Two!Ears Project -- Experiences and Best Practices}
...
\begin{frame}{Comparison with AMToolbox}
    ...
    \begin{itemize}
        ...
        \item Two!Ears needed a way to simply substitute them or get as many
...
\begin{frame}{Approaches to data management}
    ...
    \begin{itemize}
        ...
        \item There were similar implementations from single users, like
            git-media, git-annex
...
\begin{frame}{Solution}
    ...
    \begin{itemize}
        ...
        \item In both cases you can download single files
